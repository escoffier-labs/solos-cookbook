...
3. automation-host ingests those handoffs on the canonical OpenClaw host and routes them into cards, `TOOLS.md`, `USER.md`, `rules/*.md`, or `.learnings/*.md`.

On this setup, the Codex workspace instructions explicitly say:

- follow the automation-host memory handoff rule in `~/.claude/CLAUDE.md`
